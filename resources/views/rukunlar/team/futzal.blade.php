...
@section('title','Futzalchilar tarkibi')
@section('header','Futzalchilar tarkibi')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-5">
                    <h2 class="text-black">Futzalchilar tarkibi</h2>
                </div>
            </div>
            <div class="row">
                @foreach(App\Player::where('main_id',7)->get() as $player)
