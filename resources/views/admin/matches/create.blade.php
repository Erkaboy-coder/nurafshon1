...
@section('title',"Admin create foto")
...
@section('content')
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h1 class="one text-center  text-success">Create Foto</h1>
                </div>
                <div class="card-body" >
                    ...
                    <form action="{{route('admin.fotos.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="image_slug" required="required" id="" cols="30" rows="10"></textarea>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary btn-block">Create Foto</button>
                    </form>
                </div>
